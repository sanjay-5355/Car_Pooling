					...
					<div class="row g-3">
						...
						<div class="col-lg-6">
							<label for="email" class="form-label">Email</label> <input
								...
								value="<%=o.getEmail()%>" required>
						</div>

						<div class="col-lg-6">
							<label for="contact" class="form-label">Mobile Number</label> <input
								type="text" name="contact" id="mobile" class="form-control"
								value="<%=o.getContact()%>" required>
						</div>
					</div>

					<div class="text-center mt-4">
						<button type="submit" class="btn btn-update me-3" name="action" value="update">Update
							Profile</button>
						<a href="owner-change-password.jsp" class="btn btn-change">Change
							Password</a>
					</div>
				</form>
			</div>
