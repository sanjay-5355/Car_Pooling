...
<head>
<meta charset="UTF-8">
<title>Book One-Time Ride | CarPooling</title>
<link
...
<div class="container">
	<div class="form-container">
		<h2>Book Your One-Time Ride</h2>

		<form action="BookRide" method="post">
			<input type="hidden" name="serviceType" value="one-time">
			...
			<div class="form-section">
				...
				<label for="dropLocation" class="mt-3">Drop Location</label>
